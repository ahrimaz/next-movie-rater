...
export default function UserEditMoviePage() {
  ...
  useEffect(() => {
    if (status === "unauthenticated") {
      router.push(`/auth/signin?callbackUrl=/user/edit/${movieId}`);
    }
  }, [status, router, movieId]);
  ...
  // Fetch the movie data to populate the form
  useEffect(() => {
      ...
      <main className="mb-8">
        ...
        <div className="mb-8 max-w-2xl">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Search for a movie to automatically fill in details from TMDB. Your existing rating and review will be preserved.
          </p>
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl">
            ...
            <div className="col-span-full">
              ...
              {formData.poster && (
                <div className="mt-2">
                  ...
                  <div className="h-40 w-28 relative bg-gray-200">
                    {!posterError ? (
                      <Image
                        src={formData.poster}
          ...
          <div className="mt-8 flex space-x-3">
            <button
              type="submit"
              disabled={isSubmitting || !formData.title || !formData.rating}
